...
// Reuse detail hooks and tabs from users feature (same API data)
import { useUserDetail } from '@/features/users/hooks/use-user-detail'
import { WalletTab } from '@/features/users/components/detail/wallet-tab'
import { OrdersTab } from '@/features/users/components/detail/orders-tab'
import { AddressesTab } from '@/features/users/components/detail/addresses-tab'
import { ConversationsTab } from '@/features/users/components/detail/conversations-tab'
import { StatsTab } from '@/features/users/components/detail/stats-tab'
import { AccessLogsTab } from '@/features/users/components/detail/access-logs-tab'
import { TopItemsTab } from '@/features/users/components/detail/top-items-tab'

export function CustomerDetailPage() {
  const { userId } = useParams({ from: '/_authenticated/admin/customers/$userId' })
