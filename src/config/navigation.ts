    ...
    items: [
      {
        ...
        items: [
          { title: 'Todos', url: '/admin/orders?status=all' },
          { title: 'Agendados', url: '/admin/orders?status=scheduled' },
          { title: 'Pendentes', url: '/admin/orders?status=pending' },
          { title: 'Aceito', url: '/admin/orders?status=accepted' },
          { title: 'Em Preparo', url: '/admin/orders?status=processing' },
          { title: 'Ordem No Caminho', url: '/admin/orders?status=item_on_the_way' },
          { title: 'Entregue', url: '/admin/orders?status=delivered' },
          { title: 'Cancelado', url: '/admin/orders?status=canceled' },
          { title: 'Pagamento Falhou', url: '/admin/orders?status=failed' },
          { title: 'Reembolsado', url: '/admin/orders?status=refunded' },
          { title: 'Pagamento Offline', url: '/admin/orders?status=offline_payment' },
        ],
      },
      {
        title: 'Produtos',
